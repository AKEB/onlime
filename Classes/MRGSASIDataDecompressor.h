...
// This is a helper class used by MRGSASIHTTPRequest to handle inflating (decompressing) data in memory and on disk
...
@interface MRGSASIDataDecompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
