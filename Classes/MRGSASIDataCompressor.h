...
// This is a helper class used by MRGSASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface MRGSASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
