...
#import "MRGSASIHTTPRequestDelegate.h"
#import "MRGSASIProgressDelegate.h"

@interface MRGSASINetworkQueue : NSOperationQueue <MRGSASIProgressDelegate, MRGSASIHTTPRequestDelegate, NSCopying> {
...
// All MRGSASINetworkQueues are paused when created so that total size can be calculated before the queue starts
